  ...
  <main>
    <div class="flex lg:flex-row flex-col lg:items-center justify-between">
      ...
      <div class="relative flex items-center flex-grow lg:ml-20 lg:mt-0 mt-4">
        <input
          type="text"
          class="w-full h-12 border rounded-full focus:outline-none pl-20"
          placeholder="Search Recent Events"
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="w-5 h-5 absolute ml-8"
          viewBox="0 0 515.56 515.56"
        >
          <path
            d="M378.34 332.78c25.37-34.65 40.55-77.2 40.55-123.33C418.89 93.96 324.93 0 209.44 0S0 93.96 0 209.45s93.96 209.44 209.45 209.44c46.13 0 88.69-15.18 123.33-40.55L470 515.56l45.57-45.57-137.22-137.21zm-168.9 21.67c-79.95 0-145-65.04-145-145s65.05-145 145-145 145 65.04 145 145-65.04 145-145 145z"
          />
        </svg>
      </div>
    </div>
        ...
        <div class="mt-8 p-8 shadow-xs rounded-lg">
          <div class="grid lg:grid-cols-2 lg:gap-5 row-gap-5">
            ...
            <div class="flex items-center justify-between">
              ...
              <input
                ...
                class="bg-gray-100 font-light ml-10 focus:outline-none focus:shadow-outline border border-gray-300 rounded-full py-2 pl-4 lg:px-4 block appearance-none leading-normal"
                type="date"
          ...
          <div class="mt-5 flex lg:flex-row flex-col">
            ...
            >
              ...
              >
                <path
                  d="M494.14 43.16H17.86C8 43.16 0 51.16 0 61.02v389.96c0 9.86 8 17.86 17.86 17.86h476.28c9.87 0 17.86-8 17.86-17.86V61.02c0-9.86-8-17.86-17.86-17.86zm-17.86 389.96H35.72V78.88h440.56v354.24z"
                />
                <path
                  d="M191.1 122.34a65.57 65.57 0 00-65.48 65.5 65.57 65.57 0 0065.49 65.48 65.56 65.56 0 0065.48-65.49 65.57 65.57 0 00-65.48-65.49zm0 95.26a29.8 29.8 0 01-29.76-29.77 29.8 29.8 0 0129.77-29.76 29.8 29.8 0 0129.76 29.76 29.8 29.8 0 01-29.76 29.77zM352.71 269.22a17.84 17.84 0 00-17.82 1.74l-229.8 164.91 20.82 29.03 221.4-158.88 139.42 63.57 14.82-32.5-148.84-67.87z"
                />
            ...
            <textarea
              ...
              type="text"
              class="h-32 flex-grow text-sm p-2 lg:mt-0 mt-5 rounded-lg border lg:ml-10 focus:outline-none focus:shadow-outline"
            />
          </div>
        </div>
        ...
        <div class="mt-5 lg:px-10">
          ...
          >
            <slide v-for="(event, index) in allEvents.results" :key="index">
              <div
                @click="$router.push({name:'SubEvents',params:{
                events:event.slug
              }})"
                :class="`box-${index}`"
                class="rounded shadow-xl mx-4 p-6"
              >
                <img
                  v-if="event.event_flyer !== null"
                ...
                <div class="flex justify-between items-center">
                  <div>
                    <div
                      class="text-xs uppercase font-bold text-gray-800 mt-2"
                    >{{ event.event_title }}</div>
                    <div
                      class="text-xs capitalize text-gray-600 leading-3"
                    >Created: {{ event.event_start_date }}</div>
                  </div>
                  <div>
                    <svg
                      @click="deleteEvents(event.id)"
                      class="w-6 h-6 text-gray-600 fill-current mt-1"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                    >
                      <path
