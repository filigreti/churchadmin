<template>
  <main>
    ...
    <div class="mt-12">
      <h1 class="text-2xl tracking-wide text-gray-800 font-medium">Create New Articles</h1>
      <div class="mt-8 p-8 shadow-xs rounded-lg">
        ...
        <textarea
          ...
          placeholder="Description"
          type="text"
          class="h-full flex-grow text-sm p-2 mt-8 rounded-lg border w-full focus:outline-none focus:shadow-outline"
        />
      </div>
