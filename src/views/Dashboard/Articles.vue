  ...
  <main>
    ...
    <div class="mt-12">
      ...
      <div class="mt-8 p-8 shadow-xs rounded-lg">
        ...
        <textarea rows="16" placeholder="Description" type="text" class="h-full flex-grow text-sm p-2  mt-8 rounded-lg border w-full focus:outline-none focus:shadow-outline" />
      </div>
      <div class="mt-5 flex justify-end">
        <button class="bg-black text-xs uppercase leading-6 text-white font-bold py-2 px-6 rounded-lg">Publish</button>
      </div>
    </div>
  </main>
</template>
